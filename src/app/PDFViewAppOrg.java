...
public class PDFViewAppOrg extends Application {
...
//          pdfView.loadPDF(PDFViewAppOrg.class.getResourceAsStream("tesla3-owners-manual-short.pdf"));
          pdfView.loadPDF(new File("F:\\workspace2019-09\\PDFnTiffViewFXDemo\\src\\app\\tesla3-owners-manual-short.pdf")); 	
